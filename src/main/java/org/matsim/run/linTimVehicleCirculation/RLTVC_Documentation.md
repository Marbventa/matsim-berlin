...
<i>isMetropolitianArea</i> is a Boolean set to true, if the network should be split into different transit-modes.<br>
<i>predefinedFilter</i> is a String giving information about how the TrasitRoutes should be filtered. Expected is "mode", currently no alternative is implemented.<br>
<i>limitToGrossraumBerlin</i>is a Boolean set to true, if buses should be split into running inside and running outside of Berlin.<br>
...
<details open>
<summary>Design Choice</summary>
<p align="justify">30 km was chosen, because Hans Heuer defines Berlin with a 60 km diameter (see https://link.springer.com/chapter/10.1007%2F978-3-663-05165-7_1).</p>
</details>
</details>
</details>
...
<br>
<p ailign="justify">This class runs LinTim from a console inside an IDE. </p>
<br>
